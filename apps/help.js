...
const helpPath = `${_path}/plugins/mengch-plugin/resources/help`
...
export class help extends plugin {
	constructor() {
		super({
			...
			rule: [
				{
					reg: "^#?檬橙?(命令|帮助|菜单|help|说明|功能|指令|使用说明)$",
					fnc: 'help'
				},
        {
          reg: "^#?檬橙版本$",
