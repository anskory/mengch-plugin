...
const _cfgPath = `${_path}/plugins/mengch-plugin/components/`
let cfg = {}

let configPath = `${_path}/plugins/mengch-plugin/config/`
let defSetPath = './plugins/mengch-plugin/defSet/'
